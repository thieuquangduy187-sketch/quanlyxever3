        ...
        {filtered.length > PAGE_SIZE && (
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 16px',borderTop:'1px solid var(--border)',background:'var(--fill-tertiary)'}}>
            ...
            <div style={{display:'flex',gap:6}}>
              <button disabled={pg===0} onClick={()=>setPg(0)} style={{padding:'5px 10px',borderRadius:7,border:'0.5px solid var(--sep)',background:'var(--bg-card)',cursor:'pointer'}}>«</button>
              <button disabled={pg===0} onClick={()=>setPg(p=>p-1)} style={{padding:'5px 10px',borderRadius:7,border:'0.5px solid var(--sep)',background:'var(--bg-card)',cursor:'pointer'}}>‹</button>
              ...
              <button disabled={pg>=totalPg-1} onClick={()=>setPg(p=>p+1)} style={{padding:'5px 10px',borderRadius:7,border:'0.5px solid var(--sep)',background:'var(--bg-card)',cursor:'pointer'}}>›</button>
              <button disabled={pg>=totalPg-1} onClick={()=>setPg(totalPg-1)} style={{padding:'5px 10px',borderRadius:7,border:'0.5px solid var(--sep)',background:'var(--bg-card)',cursor:'pointer'}}>»</button>
            </div>
          </div>
        )}
      </div>
