      ...
      {data && <>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(4, 1fr)', gap: 10, marginBottom: 14 }}>
          ...
          {[
            ...
            { lbl: 'Tổng tiền dầu', val: fmtM(data.tongHop.tongTienDau), col: '#FF453A' },
          ].map(k => (
        ...
        <div style={{ ...V.card, marginBottom: 14 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(4, 1fr)', gap: 0 }}>
            {[
              ...
              { lbl: 'KL vận chuyển nội bộ', val: fmtNum(data.tongHop.tongKLNoiBo), unit: 'kg' },
              { lbl: 'CP thuê ngoài',    val: fmtM(data.tongHop.tongCPThue),    col: '#FF9F0A' },
            ].map((k, i) => (
        ...
        {/* ── Progress theo tỉnh ── */}
        <div style={{ ...V.card, marginBottom: 14 }}>
          <div style={V.hdr}>🗺 Tiến độ theo tỉnh</div>
          <div style={{ padding: '12px 14px', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: 8 }}>
            {data.byTinh.map(t => {
