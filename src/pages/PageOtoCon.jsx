    ...
    <div>
      <div style={{ display:'grid', gridTemplateColumns: isMobile ? 'repeat(2,1fr)' : 'repeat(4,1fr)', gap:12, marginBottom:16 }}>
        {[
          ...
          <div key={i} style={{ background:'#fff', border:'0.5px solid var(--sep)', borderRadius:12, padding:'16px 18px', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap:12, marginBottom:12 }}>
        <div style={{ background:'#fff', border:'0.5px solid var(--sep)', borderRadius:12, padding:'15px 18px' }}>
      ...
      {rows.length > 0 && (
        <div style={{ background:'#fff', border:'0.5px solid var(--sep)', borderRadius:12, overflow:'hidden' }}>
