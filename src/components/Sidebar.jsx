  ...
  return (
    <>
      ...
      <div style={S.logo}>
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#111827', lineHeight: 1.2 }}>HSG Fleet</div>
          <div style={{ fontSize: 10.5, color: '#9CA3AF' }}>Hoa Sen Home</div>
        </div>
      </div>
      ...
      <div style={S.footer}>
        ...
        {lastUpdated && (
          <div style={{ marginTop: 4, color: '#9CA3AF', fontSize: 10.5 }}>
            {new Date(lastUpdated).toLocaleTimeString('vi-VN')} {new Date(lastUpdated).toLocaleDateString('vi-VN')}
          </div>
        )}
      </div>
